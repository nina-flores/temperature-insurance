...
pub_data <- read.fst("./pub.fst")
priv_data <- read.fst("./priv.fst")
...
plots_list[[1]] <- run_analysis(unins_data, "Uninsured dataset")
plots_list[[2]] <- run_analysis(pub_data, "Publicly Insured dataset") 
plots_list[[3]] <- run_analysis(priv_data, "Privately Insured dataset") 
...
ggsave(file= "figure1_sens.pdf", a , width = 11, height = 8.5)
