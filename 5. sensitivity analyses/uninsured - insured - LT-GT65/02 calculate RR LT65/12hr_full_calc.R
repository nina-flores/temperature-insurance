...
unins.pred.12hr <- read.csv("strat.unins.12hr.pred.full.csv")
ins.pred.12hr <- read.csv("strat.ins.12hr.pred.full.csv")
...
write.csv(strat_results_12h, "strat.results.12h.full.csv")
