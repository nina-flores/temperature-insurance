...
unins.pred.48hr <- read.csv("strat.unins.48hr.pred.full.csv")
ins.pred.48hr <- read.csv("strat.ins.48hr.pred.full.csv")
...
write.csv(strat_results_48h, "strat.results.48h.full.csv")
